...
impl ReverbPlugin {
    ...
    fn update_dsp_params(&mut self) {
        ...
        // Early reflections + output EQ
        d.er_level = p.er_level.value() as f64;
        d.wet_high_cut_hz = p.wet_high_cut.value() as f64;
        d.wet_low_cut_hz = p.wet_low_cut.value() as f64;
    }
}
...
impl Plugin for ReverbPlugin {
    ...
    fn process(
        ...
        // Flush denormals on x86_64 — prevents massive slowdown from subnormal floats
        ...
        self.cached_dsp_params.sample_rate = self.sample_rate as f64;
