...
pub struct ReverbPluginParams {
    ...
    // --- Output EQ ---
    #[id = "wet_high_cut"]
    pub wet_high_cut: FloatParam,
    #[id = "wet_low_cut"]
    pub wet_low_cut: FloatParam,
}
...
fn delay_param(name: &str, default_ms: f64) -> IntParam {
    ...
    .with_value_to_string(Arc::new(|v| {
        format!("{:.1} ms", v as f64 / SR * 1000.0)
    }))
}
    ...
    fn default() -> Self {
        ...
        Self {
            ...
            feedback_gain: FloatParam::new(
                "Feedback",
                0.85,
                FloatRange::Linear { min: 0.0, max: 1.15 },
            ),
...
impl ReverbPluginParams {
    ...
    pub fn to_dsp_params(&self) -> reverb_dsp::FdnParams {
        ...
        reverb_dsp::FdnParams {
            ...
            sample_rate: reverb_dsp::params::SR,
            er_delays: reverb_dsp::params::generate_er_delays(self.delay_time_1.value()),
            er_gains: reverb_dsp::params::generate_er_gains(),
            er_pans: reverb_dsp::params::generate_er_pans(),
            er_level: self.er_level.value() as f64,
            wet_low_cut_hz: self.wet_low_cut.value() as f64,
            wet_high_cut_hz: self.wet_high_cut.value() as f64,
            meta: None,
        }
    }
}
